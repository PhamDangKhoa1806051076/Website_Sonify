  ...
  return (
    <div className="space-y-6 py-4 max-w-sm mx-auto">
      <div className="text-center space-y-2">
        ...
        <h1 className="text-xl font-bold text-white">Đăng nhập Sonify</h1>
        <p className="text-xs text-zinc-400">Truy cập toàn bộ danh sách nhạc yêu thích của bạn</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          {loading ? <i className="fa-solid fa-spinner fa-spin"></i> : 'Đăng nhập ngay'}
        </button>
      </form>

      <div className="text-center text-xs text-zinc-400">
        Chưa có tài khoản?{' '}
        <Link href="/ban%20danh%20cho%20app%20moblie/app/register" className="text-indigo-400 font-bold hover:underline">
          Đăng ký ngay
        </Link>
      </div>
    </div>
